...
export default function LoginPage() {
  ...
  const [twoFactorChallenge, setTwoFactorChallenge] =
    useState<TwoFactorLoginChallenge | null>(null);
        ...
        <form onSubmit={handleVerifyTwoFactor} className="grid gap-4">
          <div className="grid gap-2">
            ...
            <Input
              ...
              className="h-11 rounded-xl border-gray-200 text-center tracking-[0.4em] focus:border-[#E53935] focus:ring-[#E53935]/20"
            />
          </div>
          <Button
            type="submit"
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <button
              ...
              className="text-[#E53935] hover:underline underline-offset-4"
            >
              Gửi lại mã
            </button>
          </div>
