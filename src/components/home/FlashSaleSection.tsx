      ...
      <div className="overflow-hidden rounded-lg border border-border bg-card">
        ...
        <div className="group/rail relative p-3">
          <Button
            ...
            className="absolute left-2 top-1/2 z-10 hidden -translate-y-1/2 rounded-full shadow-md md:flex opacity-0 group-hover/rail:opacity-100 hover:-translate-y-1/2 hover:scale-105 active:scale-95 transition-all"
          >
          ...
          <Button
            ...
            className="absolute right-2 top-1/2 z-10 hidden -translate-y-1/2 rounded-full shadow-md md:flex opacity-0 group-hover/rail:opacity-100 hover:-translate-y-1/2 hover:scale-105 active:scale-95 transition-all"
          >
