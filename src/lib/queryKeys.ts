...
export const wishlistKeys = {
  ...
  list: (params?: { page?: number; limit?: number }) => [...wishlistKeys.lists(), params] as const,
...
export const shopCategoryKeys = {
  ...
  byShop: (shopId: string) => [...shopCategoryKeys.all, 'shop', shopId] as const,
...
export const reviewKeys = {
  ...
  shop: (shopId: string, params?: unknown) => [...reviewKeys.all, 'shop', shopId, params] as const,
...
export const statisticsKeys = {
  ...
  revenue: (params?: unknown) => [...statisticsKeys.all, 'revenue', params] as const,
  orders: (params?: unknown) => [...statisticsKeys.all, 'orders', params] as const,
  products: (params?: unknown) => [...statisticsKeys.all, 'products', params] as const,
};
...
export const voucherKeys = {
  ...
  shopPublic: (shopId: string) => [...voucherKeys.all, 'shop-public', shopId] as const,
  detail: (voucherId: string) => [...voucherKeys.all, 'detail', voucherId] as const,
...
export const chatbotKeys = {
  ...
  adminSessions: (params?: unknown) => [...chatbotKeys.all, 'admin-sessions', params] as const,
  history: (sessionId: string) => [...chatbotKeys.all, 'history', sessionId] as const,
};
